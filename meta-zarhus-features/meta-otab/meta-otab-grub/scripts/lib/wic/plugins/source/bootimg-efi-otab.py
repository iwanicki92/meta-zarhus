...
class BootimgPartitionPlugin(SourcePlugin):
    ...
    It's jut modified version of bootimgpartition
    extended with EFI partition creation
    """

    name = 'bootimg-efi-otab'

    @classmethod
    def do_prepare_efi_partition(cls, part, cr_workdir, oe_builddir, hdddir,
                                 native_sysroot):
        """
    ...
    def do_prepare_partition(cls, part, source_params, cr, cr_workdir,
        ...
        cls.do_prepare_efi_partition(part, cr_workdir, oe_builddir, hdddir,
                                     native_sysroot)
